...
export default function Aplicativos(){
    ...
    return(
        <Container fluid={true} className='p-0 m-0'  style={{overflow: 'hidden'}}>
            <h2 className='text-light text-center m-0 pt-5 title_responsive_clube' style={{backgroundColor: 'rgba(0,0,0,0.5)'}} >Conheça o seu Clube de Vantagens</h2>
            <Row className='d-flex justify-content-around p-5 height_responsive_clube' style={{backgroundColor: 'rgba(0,0,0,0.5)',height: '60vh'}} >
                ...
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-lg-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold title_responsive_clube'>Rede de Compras</h2>
                    <p className="description_subcategoria_clube text-light">
            ...
            <Row className='d-flex justify-content-around p-5 height_responsive_clube' style={{backgroundColor: 'rgba(0,0,0,0.7)',height: '60vh'}} >
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-lg-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold title_responsive_clube'>Correct Shop</h2>
                    <p className="description_subcategoria_clube text-light">
            ...
            <Row className='d-flex justify-content-around p-5 height_responsive_clube' style={{backgroundColor: 'rgba(0,0,0,0.5)',height: '60vh'}} >
                ...
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-lg-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold title_responsive_clube'>Fidelidade</h2>
                    <p className="description_subcategoria_clube text-light">
            ...
            <Row className='d-flex justify-content-around p-5 height_responsive_clube' style={{backgroundColor: 'rgba(0,0,0,0.7)',height: '60vh'}} >
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-lg-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold title_responsive_clube'>Delivery</h2>
                    <p className="description_subcategoria_clube text-light">
            ...
            <Row className='d-flex justify-content-around p-5 height_responsive_clube' style={{backgroundColor: 'rgba(0,0,0,0.5)',height: '80vh'}} >
                <Box pose={isVisible ? 'visible' : 'hidden'} className='align-items-center justify-content-center row col-lg-4'>
                    <img src={require('../../assets/cartoes/card_solimed.png')} className="card_image" style={{width:  '60% !important'}} alt='Saúde e bem estar'/>
                </Box>
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-lg-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold title_responsive_clube'>Saúde e Bem Estar</h2>
                    <p className="description_subcategoria_clube text-light">
                    ...
                    <Row>
                        <ul style={{listStyle: 'circle', fontSize: '0.8rem'}} className='col-lg-4 text-light'>
                            <li>Hospitais</li>
