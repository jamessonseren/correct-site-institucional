...
export default function Aplicativos(){
    ...
    return(
        <Container fluid={true} className='p-0 m-0'  style={{overflow: 'hidden'}}>
            <h2 className='text-light text-center m-0 pt-5' style={{backgroundColor: 'rgba(0,0,0,0.5)'}} >Conheça o seu Clube de Vantagens</h2>
            <Row className='d-flex justify-content-around p-5' style={{backgroundColor: 'rgba(0,0,0,0.5)',height: '50vh'}} >
                ...
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold'>Rede de Compras</h2>
            ...
            <Row className='d-flex justify-content-around p-5' style={{backgroundColor: 'rgba(0,0,0,0.7)',height: '50vh'}} >
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold'>Correct Shop</h2>
                    <p className="description_subcategoria">
            ...
            <Row className='d-flex justify-content-around p-5' style={{backgroundColor: 'rgba(0,0,0,0.5)',height: '50vh'}} >
                ...
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold'>Fidelidade</h2>
                    <p className="description_subcategoria">
            ...
            <Row className='d-flex justify-content-around p-5' style={{backgroundColor: 'rgba(0,0,0,0.7)',height: '50vh'}} >
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold'>Delivery</h2>
                    <p className="description_subcategoria">
            ...
            <Row className='d-flex justify-content-around p-5' style={{backgroundColor: 'rgba(0,0,0,0.5)',height: '50vh'}} >
                ...
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold'>Saúde e Bem Estar</h2>
                    <p className="description_subcategoria">
                    ...
                    <Row>
                        <ul style={{listStyle: 'circle', fontSize: '0.8rem'}} className='col-4 text-light'>
                            <li>Hospitais</li>
