        ...
        <Container fluid={true} className='p-0 m-0'  style={{overflow: 'hidden'}}>
            <Row className='d-flex justify-content-around p-5' style={{backgroundColor: 'rgba(0,0,0,0.5)',height: '50vh'}} >
                ...
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-4' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold'>Parceiros</h2>
                    ...
                    <Link className='btn-sm btn-club mt-2 text-center' >Clique para baixar o nosso módulo de vendas</Link>
                </Box>
            </Row> 
            <Row className='d-flex justify-content-around p-5' style={{backgroundColor: 'rgba(0,0,0,0.7)',height: '80vh'}} >
                <Box pose={isVisible ? 'visible' : 'hidden'} className='d-flex justify-content-center row col-8' style={{flexDirection: 'column'}}>
                    <h2 className='text-light font-weight-bold'>Outras vantagens para os nossos parceiros</h2>
